...
// A manager (hr_manager) can only ever grant/see the base "hr" role — the
// backend enforces this too (users.py's create/update checks), this is
// just not offering an option that would 403. A true admin can grant any tier.
function assignableRoles(me: HrUser): string[] {
  return me.role === 'admin' ? ['hr', 'hr_manager', 'admin'] : ['hr']
}
